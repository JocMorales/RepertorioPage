// Datos de las canciones (simulando la tabla del Excel)
...
const songs = [
    ...
    function renderSongs(filteredSongs) {
      ...
      filteredSongs.forEach((song) => {
        ...
        songCard.innerHTML = `
          <h3 class="text-xl font-semibold text-Title">${song.cancion}</h3>
    ...
    document.getElementById("noteFilter").addEventListener("change", filterSongs);
    document.getElementById("typeFilter").addEventListener("change", filterSongs);
